...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            # Check whether this node's preconditions are met by previous state
    ...
    def add_literal_level(self, level):
        ...
        for node_a in self.a_levels[level - 1]:
            # Find the effect nodes for the previous level as they are current level's state nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Check whether node_a1's effects are removed by node_a2's effects
        for effect in node_a1.action.effect_add:
            if effect in node_a2.action.effect_rem:
                return True

        # Check whether node_a2's effects are removed by node_a1's effects
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Check whether node_a1's +ve effects conflict with node_a2's -ve preconditions
        # Check whether node_a1's -ve effects conflict with node_a2's +ve preconditions
        for effect in node_a1.action.effect_add:
        ...
        # Check whether node_a2's +ve effects conflict with node_a1's -ve preconditions
        # Check whether node_a2's -ve effects conflict with node_a1's +ve preconditions
        for effect in node_a2.action.effect_add:
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        #check whether node_a1's preconditions are mutex with node_a2's preconditions
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # Check whether node_s1's preconditions are mutually exclusive with node_s2's preconditions
